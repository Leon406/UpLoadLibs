...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            iv_mask = (ImageView) itemView.findViewById(R.id.iv_mask);
            iv_border = (ImageView) itemView.findViewById(R.id.iv_border);
    ...
    public void selectImage(ViewHolder holder, boolean isChecked, boolean isAnim) {
        ...
        holder.iv_border.setVisibility(isChecked ? View.VISIBLE : View.GONE);
////        holder.iv_mask.setVisibility(View.GONE);
//        //add mask
//        if (selectImages.size() >= config.maxSelectNum) {
//            holder.iv_mask.setVisibility(isChecked ? View.GONE : View.VISIBLE);
//        } else {
//            holder.iv_mask.setVisibility(View.GONE);
//        }
        if (isChecked) {
